...
export function RobinhoodTrendingPanel() {
  ...
  return (
    <aside
      ...
      aria-label={activeTab === "solana" ? "Solana trending tokens" : "Robinhood Chain trending tokens"}
    >
      ...
      <div className={styles.header}>
        <div>
          <b>{activeTab === "solana" ? "TRENDING · SOLANA" : "TRENDING · ROBINHOOD CHAIN"}</b>
          <span className={styles.pulseRow}>
            <span className={styles.dot} /> {activeTab === "solana" ? "Solana" : "Robinhood Chain"}
          </span>
        </div>
