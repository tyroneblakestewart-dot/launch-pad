  ...
  },
  {
    ...
    elements: [
      ...
      { id: "header_title", type: "heading", label: "Header title", defaultValue: "Choose how you sign in." },
      {
        ...
        label: "Header intro copy",
        defaultValue:
          "Sign in with Google to keep your email on file and, soon, your projects across devices. Every launch, payment and post still asks your wallet.",
      },
      ...
      { id: "google_note", type: "text", label: "Google row note", defaultValue: "Email on file · projects across devices soon" },
