...
export const AI_FEATURE_KEYS = {
  ...
  SOCIAL_ANNOUNCEMENT: "social.announcement",
  SOCIAL_ANNOUNCEMENT_RETRY: "social.announcement-retry",
...
const FEATURE_GROUP_PREFIXES: Array<{ prefix: string; label: string }> = [
  ...
  { prefix: "social.voice-sample", label: "Voice sample" },
  { prefix: "social.draft", label: "Social draft" },
  { prefix: "social.announcement", label: "Announcement jazz-up" },
