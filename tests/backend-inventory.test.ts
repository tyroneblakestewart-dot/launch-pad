...
describe("backend test inventory", () => {
  it("lists every current API route and its exported HTTP method", async () => {
    ...
    expect(routeFiles).toEqual([
      ...
      "app/api/social/approval-session/route.ts",
      "app/api/social/buy-bot/disable/route.ts",
      "app/api/social/buy-bot/route.ts",
      "app/api/social/buy-bot/update/route.ts",
      ...
      "app/api/social/post-image/route.ts",
      ...
      "app/api/social/x/status/route.ts",
    ...
    expect(Object.fromEntries(methods)).toEqual({
      ...
      "app/api/cron/buy-bot/route.ts": ["GET"],
      ...
      "app/api/social/approval-session/route.ts": ["DELETE", "GET", "POST"],
      "app/api/social/buy-bot/disable/route.ts": ["POST"],
      "app/api/social/buy-bot/route.ts": ["GET", "POST"],
      "app/api/social/buy-bot/update/route.ts": ["POST"],
      ...
      "app/api/social/post-image/route.ts": ["POST"],
      ...
      "app/api/social/stats/route.ts": ["GET"],
      ...
      "app/api/social/x/status/route.ts": ["GET"],
  ...
  it("lists every extracted server module covered by the suite", async () => {
    ...
    expect(serverFiles).toEqual([
      ...
      "lib/server/post-image-prompt.ts",
      ...
      "lib/server/social-approval-session-store.ts",
      "lib/server/social-approval-session.ts",
