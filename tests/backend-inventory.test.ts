...
describe("backend test inventory", () => {
  it("lists every current API route and its exported HTTP method", async () => {
    ...
    expect(routeFiles).toEqual([
      ...
      "app/api/admin/support/suggest/route.ts",
    ...
    expect(Object.fromEntries(methods)).toEqual({
      ...
      "app/api/admin/support/suggest/route.ts": ["POST"],
  ...
  it("lists every extracted server module covered by the suite", async () => {
    ...
    expect(serverFiles).toEqual([
      ...
      "lib/server/support-knowledge/error-catalogue.ts",
      "lib/server/support-knowledge/feature-flows.ts",
      "lib/server/support-knowledge/index.ts",
      "lib/server/support-knowledge/known-issues.ts",
      "lib/server/support-knowledge/select-knowledge.ts",
      "lib/server/support-knowledge/system-dependencies.ts",
      "lib/server/support-knowledge/types.ts",
      "lib/server/support-suggestion-pipeline.ts",
